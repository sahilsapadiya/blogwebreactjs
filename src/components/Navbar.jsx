...
const Navbar = () => {
  ...
  return (
    <>
      <div className='flex justify-between items-center p-9 bg-background/50 backdrop-blur fixed rounded-[300px] mt-[20px] h-[70px] top-0 left-0 w-full text-white  '>
  
        <div className='hover:text-black text-[25px] pl-[9px]'>OUR BLOG</div>
